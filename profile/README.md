...
| **[intellij-plugin](https://github.com/AI-Unified-Process/intellij-plugin)** | *AI Unified Process Navigator* — jumps between `@UseCase`-annotated test methods and their Markdown specs, and renders a live activity diagram of the spec you are editing. [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/31481-ai-unified-process-navigator/) · [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=aiup.aiup-navigator) |
